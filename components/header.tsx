...
const Header = () => {
  // The below statement is causing because we have defined activeSection as null. This make promise Hooks
  // variable is null at the execution or can be null so we need to correct this below statement by creating a new
  // custom hook
 //  const {activeSection,setActiveSection} =  useContext(ActiveSectionContext) [This will give error]
 ...
 return (
    ...
    sm:rounded-full dark:bg-gray-950 dark: border-black/40 dark:bg-opacity-75'
     ...
     <nav className=" flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:h-[initial] sm:py-0">
        ...
        font-medium text-gray-600 sm:w-[initial] sm:flex-nowrap sm:gap-6'>
            {links.map((link) => (
